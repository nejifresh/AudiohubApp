...
public class TitleAdapter extends RecyclerView.Adapter<TitleAdapter.MyViewHolder> {
    ...
    public TitleAdapter(Context mContext, List<Title> titleList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.coverImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                globalVariable.setCategory(title.getCategory());
                globalVariable.setDocType(title.getDocType());
    ...
    private void showPopUpMenu(View view){
        ...
        popupMenu.setOnMenuItemClickListener(new TitleAdapter.MyMenuItemClickListener());
    }

...
import com.nejitawo.audiohub.Adapters.DownloadAdapter;
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                for (ParseObject menu : ob) {
                    ...
                    Download t = Download.giveFullDetails(menu, getApplicationContext());
                    if (t != null) {
                        titleList.add(t);
                    }
            ...
            adapter = new DownloadAdapter( getApplicationContext(),titleList);

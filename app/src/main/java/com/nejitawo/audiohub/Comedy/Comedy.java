 ...
 */
public class Comedy extends Fragment implements ComedyContract {
    ...
    private static String CATEGORY = "Comedy";
    ...
    @Override
    public void showComedyWorks() {
        new loadComedy().execute();
    }
    ...
    public class loadComedy extends AsyncTask<Void, Void, Void> {
